...
export default function Home() {
	const [CommentsBoard, setCommentsBoards] =
		...
		<section className="flex w-full flex-1 justify-center px-4 py-6 flex-col gap-7 items-center">
			{CommentsBoard && (
				<section className="fixed z-50 flex w-full h-full items-center justify-center">
					<div className="relative flex flex-col w-125 max-w-[95vw] h-130 rounded-2xl border border-border bg-card/90 shadow-xl animate-[PopIn_50ms_ease-in-out] overflow-hidden backdrop-blur-lg" ref={CommentsBoardRef}>
						<div className="flex items-center justify-between border-b border-border px-4 py-3">
							<span className={fonts.cabin.className}>
								Comments
							</span>
